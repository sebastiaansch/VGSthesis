...
parser.add_argument('-data_loc', type = str, default = '/Users/sebastiaanscholten/Documents/speech2image-master/vgsexperiments/experiments/Generating_Flickrwords_mfcc/mfcc/words_mfcc_features.h5')
...
nouns_txt = pd.read_csv("/Users/sebastiaanscholten/Documents/speech2image-master/vgsexperiments/experiments/data/testwords.txt", header=None)
...
for img, cap in zip(img_models, caption_models):
    ...
    resultsat10, whichimages = trainer.word_precision_at_n(mfcc_test, images_test,"/Users/sebastiaanscholten/Documents/speech2image-master/vgsexperiments/experiments/data/imagecaptiontextdictionary.json", 10, args.batch_size)
